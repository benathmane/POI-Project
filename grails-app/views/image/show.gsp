    ...
    <ol class="property-list image">
        ...
        <g:if test="${imageInstance?.name}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${imageInstance}"
                                                                                        field="name"/></span>
        ...
        <g:if test="${imageInstance?.path}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="path-label"><g:fieldValue bean="${imageInstance}"
                                                                                        field="path"/></span>
